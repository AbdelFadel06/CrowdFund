...
export default function CampaignDetails() {
  ...
  const contributionsCount = info.contributionsCount || 0;
  ...
  return (
    <div className="max-w-6xl mx-auto mt-10 p-6 bg-white rounded-2xl shadow-lg flex flex-col md:flex-row gap-6">
      ...
      <div className="md:w-2/5 w-full flex flex-col justify-between">
        ...
        <div className="flex justify-between mt-4 mb-4">
          ...
          <div className="flex-1 bg-gray-100 p-3 rounded-lg text-center mx-2">
            ...
            <p className="font-bold">{contributionsCount}</p>
          </div>
